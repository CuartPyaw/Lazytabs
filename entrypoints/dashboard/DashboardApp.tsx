  ...
  return (
    <main className="flex min-h-dvh flex-col bg-background text-foreground lg:h-dvh">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-4 py-6 sm:px-8 lg:overflow-hidden">
        <div className="mx-auto grid max-w-7xl gap-6 lg:h-full lg:grid-cols-[minmax(0,1.1fr)_minmax(20rem,0.9fr)] lg:grid-rows-[minmax(0,1fr)]">
          <section className="no-scrollbar flex min-w-0 flex-col gap-4 lg:min-h-0 lg:overflow-y-auto" aria-labelledby="current-tabs-heading">
